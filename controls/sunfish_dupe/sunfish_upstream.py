...
class Searcher:
    def __init__(self):
        ...
        # Local research adapter extension. Upstream's UCI layer exposes
        # ``go nodes`` but checks the cap only between MTD probes; keeping the
        # stop in the recursive search makes equal-node tests exact.
        self.node_cap = 0
