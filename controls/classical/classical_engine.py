"""Original classical chess engine used as the non-distillation control.

The search follows standard, published alpha-beta techniques used across many
engines.  It deliberately shares no code or weights with the distilled agent.
"""
...
class ClassicalEngine:
    """Iterative-deepening PVS with a handcrafted tapered evaluation."""
